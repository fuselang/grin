...
module AbstractInterpretation.ExtendedSyntax.LiveVariable.CodeGenBase where
...
import Control.Monad (forM, forM_, zipWithM, replicateM)
...
import AbstractInterpretation.ExtendedSyntax.IR (Instruction(..), Reg(..))
